...
# Dataset uploaded by the local app (flattened: storyboard.json + scene_*.png)
PROJECT_FOLDER = "/kaggle/input/{dataset_slug}"
JSON_PATH = f"{{PROJECT_FOLDER}}/storyboard.json"
